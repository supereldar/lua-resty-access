...
<div class="container">
	...
	body = body..'<div class="form-group"></div>'
        if not otp then 
		body = body..'<button onClick="javascript: document.getElementById(\'Form\').submit()" style="width: 100%" type="button" class="btn btn-primary">Send me a code!</a>'
	else
		body = body..'<button onClick="javascript: document.getElementById(\'Form\').submit()" style="width: 100%" type="button" class="btn btn-primary">Sign in!</button></form><br>'
